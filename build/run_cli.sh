...
CLIENT_ID_TO_USE="mon_client_id_depuis_script" # <<< Remplacer par la variable/source réelle de l'ID
CLIENT_TOKEN_TO_USE="mon_token_depuis_script"   # <<< Remplacer par la variable/source réelle du Token
